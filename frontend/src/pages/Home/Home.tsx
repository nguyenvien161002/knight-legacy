...
function Home() {
    ...
    return <div className={cx('home')}>
        ...
        <section className={cx('bg__content-top')}>  
            <div className={cx('bg__content-shadow')}>

            </div>
            <div className={cx('bg__content-bookmark')} >
        ...
        <section className={cx('bg__content-center')}>
            <div className={cx('bg__gradient-content')}>
                <div className={cx('bg__gradient-item')}>
                    <div><img src={kata} width="300"  alt="" className={cx('product__image')} /></div>
                ...
                <div className={cx('intro__content')}> 
                    <div className={cx('intro__content-left')}>
                        <div className={cx('intro__content-item')}>
                            ...
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Optio consectetur vel cumque aperiam, maxime culpa repudiandae, consequuntur distinctio nisi?</p>
                        ...
                        <ul className={cx('intro__character-list')}>
                            <li className={cx('intro__character-item')}>
                                ...
                                <div className={cx('intro__character-btn')}>
                                    <div>
                                        <button>  Bib <FontAwesomeIcon icon={faArrowRightIC} /> </button>
                                    </div>
                                </div>
                            </li>
                            <li className={cx('intro__character-item')}>
        ...
        <footer className={cx('footer')}>
            ...
            <div className={cx('footer__content')}>
                <div className={cx('footer__content-intro')} >
                    <h3> Knight NFT's</h3>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Alias eius officiis eligendi maiores dolorum voluptatem repellat facere?</p>
                </div>
                ...
                <div className={cx('footer__content-news')}>
                    ...
                    <div  className={cx('footer__content-form')}>
                        <form action="">
                            ...
                            <button> <FontAwesomeIcon icon={faArrowRightIC}/> </button>
                        </form>
                    </div>
                </div>
            </div>
