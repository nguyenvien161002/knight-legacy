...
function ShowFormKnight() {
  ...
  return (
    <div className={cx("modal-container")}>
      <p>
        Chào mừng bạn đến với Knight NFT, Hãy tạo Knight đầu tiền của bạn và
        tham gia cuộc chiến cùng chúng tôi nhé.{" "}
      </p>
      <p>
        Nhấp vào nút <b>"Create knight"</b> để tiếp tục!
      </p>
          ...
          <div className={cx("banner")}>
            ...
            <div className={cx("banner__submit", "banner__item")}>
              ...
              <div className={cx("banner__expr")}>
                <p>
                  Ending In{" "}
                  <span className={cx("color-global")}>2d:15h:20m</span>
                </p>
              </div>
            </div>
          </div>
            ...
            <div className={cx("feed")}>
              ...
              <div className={cx("feed__choice")}>
                <ul className={cx("feed__choice-list")}>
                  <li className={cx("feed__choice-list-item", "active")}>
                    All
                  </li>
              ...
              <div className={cx("card-item")}>
                ...
                <div className={cx("card-content")}>
                  ...
                  <div className={cx("card-submit", "flex-card")}>
                    <a href="#" className={cx("card-button", "active")}>
                      Place A Bid
                    </a>
                    <a href="#" className={cx("card-button")}>
                      History
                    </a>
                  </div>
                </div>
